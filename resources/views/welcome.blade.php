            ...
            <div class="row">
                <div class="portfolio-items">
                    ...
                    <div class="col-sm-6 col-md-4 garden">
                        <div class="portfolio-item">
                            <div class="hover-bg">
                                <a href="assets/welcome/img/portfolio/07-large.jpg" title="Project Title"
                                    data-lightbox-gallery="gallery1">
                                    <div class="hover-text">
                                        <h4>Dolor Sit</h4>
                                    </div>
                                    <img src="assets/welcome/img/portfolio/07-small.jpg" class="img-responsive"
                                        alt="Project Title" />
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4 lawn">
                        <div class="portfolio-item">
                            <div class="hover-bg">
                                <a href="assets/welcome/img/portfolio/08-large.jpg" title="Project Title"
                                    data-lightbox-gallery="gallery1">
                                    <div class="hover-text">
                                        <h4>Lorem Ipsum</h4>
                                    </div>
                                    <img src="assets/welcome/img/portfolio/08-small.jpg" class="img-responsive"
                                        alt="Project Title" />
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4 planting">
                        <div class="portfolio-item">
                            <div class="hover-bg">
                                <a href="assets/welcome/img/portfolio/09-large.jpg" title="Project Title"
                                    data-lightbox-gallery="gallery1">
                                    <div class="hover-text">
                                        <h4>Adipiscing Elit</h4>
                                    </div>
                                    <img src="assets/welcome/img/portfolio/09-small.jpg" class="img-responsive"
                                        alt="Project Title" />
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div id="testimonial" class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="faqs-question">What is GreenQuest's mission?</div>
                                <div class="faqs-answer">GreenQuest's mission is to promote environmental sustainability
                                    through tree
                                    planting and conservation efforts.</div>
                            </div>
                            <div class="item">
                                <div class="faqs-question">How can I get involved with GreenQuest?</div>
                                <div class="faqs-answer">You can get involved with GreenQuest by volunteering for tree
                                    planting events,
                                    donating to support our projects, or spreading awareness about our mission.</div>
                            </div>
                            <div class="item">
                                <div class="faqs-question">How does GreenQuest ensure the sustainability of its
                                    projects?</div>
                                <div class="faqs-answer">GreenQuest works closely with local communities and
                                    environmental experts to
                                    ensure that tree planting projects are sustainable and have a positive long-term
                                    impact.</div>
                            </div>
                            <div class="item">
                                <div class="faqs-question">Is my donation tax-deductible?</div>
                                <div class="faqs-answer">Yes, donations made to GreenQuest are tax deductible to the
                                    extent allowed by
